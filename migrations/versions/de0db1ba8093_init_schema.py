...
def upgrade() -> None:
    ...
    sa.Column('is_deleted_by_sender', sa.Boolean(), server_default='false', nullable=False),
    sa.Column('is_deleted_by_recipient', sa.Boolean(), server_default='false', nullable=False),
